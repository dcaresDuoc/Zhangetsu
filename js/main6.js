...
thumbnails.forEach(thumbnail => {
    thumbnail.addEventListener('click', event=>{
        ...
        imageContainer.style.backgroundImage = `url('../img/image-product-6-${event.target.id}.jpg')`
    });
...
modalthumbnails.forEach(modalthumbnail =>{
    modalthumbnail.addEventListener('click', event=>{
        ...
        modalImageContainer.style.backgroundImage = `url('../img/image-product-6-${event.target.id.slice(-1)}.jpg')`
...
function  drawProductInModal(){
        ...
        <div class="cart-modal__details-container">
            ...
            <div>
                <p class="cart-modal__product">Gundam ...</p>
    ...
    deleteProduct()
    let priceModal = document.querySelector('.cart-modal__price');
    priceModal.innerHTML = `$150.000 x ${lastValue} ---> Total: <span> $${lastValue*150}.000</span>`
}
...
function changeNextImage(imgContainer){
    ...
    imgContainer.style.backgroundImage = `url('../img/image-product-6-${imgIndex}.jpg')`
}
